...
//Función que coge la primera letra de una frase
...
frontPassword += frontDoorResponse("Stands so high ");
frontPassword += frontDoorResponse("Huge hooves too");
frontPassword += frontDoorResponse("Impatiently waits for");
frontPassword += frontDoorResponse("Reins and harness");
frontPassword += frontDoorResponse("Eager to leave");

console.log(frontDoorPassword(frontPassword)); //Shire

//Función que coge la última letra de una frase, excepto si hay un espacio
//que cogería la penúltima letra
...
//Función para poner la primera letra en mayúsculas y añadir "please" al final de la frase
function backDoorPasword(word)
{
...
backPassword += backDoorResponse("Stands so high ");
backPassword += backDoorResponse("Huge hooves too");
backPassword += backDoorResponse("Impatiently waits for");
backPassword += backDoorResponse("Reins and harness");
backPassword += backDoorResponse("Eager to leave");

console.log(backDoorPasword(backPassword)); //Horse, please
